      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="statistics-details d-flex align-items-center justify-content-between">
            ...
            <div>
              <p class="statistics-title">Total Student Enrolled</p>
              <h3 class="rate-percentage">{{ $totalEnroll }}</h3>

            </div>
            <div>
              <p class="statistics-title">Total Ongoing Courses</p>
              <h3 class="rate-percentage">{{ $course }}</h3>
